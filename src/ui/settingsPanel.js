...
const SECTIONS = [
  {
    ...
    fields: [
      ...
      { key: 'detailedRocketModel', label: 'Scanned firework', type: 'toggle', help: 'Puts a generated mesh of a firework in your hand in place of the five boxes it is built from. Off by default: side by side at the size it is actually seen, the built one reads as a tube with a nose and the scan reads as a dark smudge, because it carries a photograph with its own lighting baked in. Judge it yourself.' },
