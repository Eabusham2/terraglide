...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'renderDistanceKm', label: 'Render distance', type: 'range', min: 4, max: 220, step: 2, unit: ' km' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'elytraDurability', label: 'Elytra wears out', type: 'toggle', help: 'One point a second, out of 432, exactly like the real thing.' },
      { key: 'infiniteRockets', label: 'Unlimited rockets', type: 'toggle' },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'rtpRange',
        label: 'Random teleport range',
        type: 'select',
        options: () => [
          { value: 'unlimited', label: 'Anywhere on Earth' },
          { value: 'radius', label: 'Within a distance of here' },
        ],
      },
      { key: 'rtpRadiusKm', label: 'Teleport radius', type: 'range', min: 5, max: 5000, step: 5, unit: ' km' },
      {
        key: 'timeMode',
        label: 'Time of day',
        type: 'select',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'minimapFog', label: 'Shade unexplored ground', type: 'toggle' },
      { key: 'minimapShowPaths', label: 'Show paths', type: 'toggle' },
